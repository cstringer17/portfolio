...
function getCommands() {
    ...
    try {
        for (var _iterator = Object.entries(commands)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
function getRepos() {
    ...
    fetch('https://api.github.com/users/cstringer17/repos').then(function (response) {
